...
import { Download, FileText, BarChart3, ArrowLeft } from "lucide-react";
...
export default function ResultsDisplay({
  ...
  const handlePrintPDF = async () => {
    ...
    try {
      ...
      // Save PDF
      const fileName = `INDI40_Assessment_${
    ...
    <>
                  ...
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <div className="text-right min-w-30">
                      ...
                      <div className="text-xs text-gray-600">
                        Level {detail.level}:{" "}
                        {getLevelDescription(detail.level)}
                      </div>
                    </div>
                  </div>
                ...
                <div className="mt-4 pt-4 border-t border-blue-200">
                  ...
                  <ul className="text-sm text-blue-800 space-y-1 list-disc list-inside">
                    {results.overallLevel === 0 && (
                      <>
                        <li>
                          Mulai dengan sosialisasi konsep Industri 4.0 ke
      ...
      <div ref={printRef} style={{ display: "none" }}>
        <div style={{ fontFamily: "Arial, sans-serif", color: "#1f2937" }}>
          ...
          <div style={{ marginBottom: "24px" }}>
            ...
            {Object.entries(results.pillarDetails).map(([key, detail]) => (
              ...
              >
                ...
                >
                  <strong style={{ fontSize: "16px" }}>{detail.title}</strong>
          ...
          >
            <p>© 2026 INDI 4.0 Assessment Platform - Total Quality Indonesia</p>
            <p style={{ marginTop: "4px" }}>
              Dokumen ini dihasilkan secara otomatis dari sistem assessment INDI
              4.0
            </p>
          </div>
        </div>
